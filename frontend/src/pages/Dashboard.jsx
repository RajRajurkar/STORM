      ...
      >
        ...
        >
          <motion.div className="flex items-center gap-3">
            <motion.div variants={iconFloatVariants} animate="animate">
        ...
        >
          ...
          >
            <motion.div className="absolute inset-0 bg-gradient-to-r from-primary-700 to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity" />
            <motion.div
        ...
        >
          ...
          >
            {[
              ...
              {
                value: analytics?.avg_stp_time_ms || 0,
                suffix: "ms",
                label: "STP Processing",
        ...
        >
            ...
            {[
              {
                ...
                desc: "Process new insurance application",
                bg: "bg-primary-50",
              ...
              },
              {
                ...
                desc: "What-if scenario analysis",
                bg: "bg-green-50",
          ...
          >
            ...
            <motion.div
              ...
              animate="visible"
            >
              {Object.entries(analytics?.risk_distribution || {}).map(
