    ...
    <div className="max-w-6xl mx-auto space-y-8">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-blue-600">
                        ${premium.final_premium.toLocaleString("en-US")}
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-green-600">
                        ...
                        {premium.payment_options?.monthly
                          ? premium.payment_options.monthly.toLocaleString(
                              "en-US",
                            )
                          : "N/A"}
                      </p>
          ...
          {premium && (
            <div className="mt-6 pt-6 border-t border-gray-100">
              ...
              <div className="space-y-2">
                {Object.entries(premium.premium_breakdown || {}).map(
                  ([key, value]) => (
                    <div key={key} className="flex justify-between text-sm">
                      <span className="text-gray-500">{key}</span>
                      <span
                        className={`font-medium ${value < 0 ? "text-green-600" : "text-gray-900"}`}
                      >
                        {value < 0 ? "-" : ""}$
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        >
          ...
          <ContributionBars
            contributions={risk_assessment.contributions.slice(0, 8)}
          />
        </motion.div>
